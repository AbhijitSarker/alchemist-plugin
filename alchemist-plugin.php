...
class AlchemistPlugin
{
    ...
    public function settings_link($links)
    {
        ...
        $setting_link = '<a href="admin.php?page=alchemist_plugin">Settings</a>';
...
register_activation_hook(__FILE__, array('AlchemistPluginActivate', 'activate'));

//deactivation

require_once plugin_dir_path(__FILE__) . 'inc/alchemist_plugin_deactivate.php';
register_deactivation_hook(__FILE__, array('AlchemistPluginDeactivate', 'deactivate'));
